...
tests = [{"params": "--rmat --s 20 --e 32 --check", "weight": 5.0},
         {"params": "--random_uniform --s 21 --e 32 --check", "weight": 2.0},
         {"params": "--random_uniform --s 24 --e 32 --check", "weight": 2.0},
         {"params": "--rmat --s 24 --e 32 --check", "weight": 2.0},
         {"params": "--rmat --s 21 --e 32 --check", "weight": 3.0}]
